  ...
  const schema = {
      ...
      "/api/memory/context": {
        get: {
          ...
          responses: {
            "200": {
              ...
              content: {
                "application/json": {
                  schema: { $ref: "#/components/schemas/UserContextResponse" }
                }
              }
            },
            "401": {
        ...
        post: {
          ...
          requestBody: {
            ...
            content: {
              "application/json": {
                schema: { $ref: "#/components/schemas/SaveUserContextRequest" }
              }
            }
          },
          responses: {
    ...
    components: {
      schemas: {
        ...
        ProductResponse: {
          type: "object",
          required: ["ok", "link_type", "affiliate_url", "partner_tag", "marketplace"],
          properties: {
            ok: { type: "boolean" },
        ...
        UserContextResponse: {
          ...
          properties: {
            ok: { type: "boolean" },
            found: { type: "boolean" },
            consent_personalization: { type: ["boolean", "null"] },
            consent_history: { type: ["boolean", "null"] },
            context: {
              type: ["object", "null"],
              additionalProperties: true,
              properties: {}
