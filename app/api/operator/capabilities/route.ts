...
export async function GET(request: NextRequest) {
  ...
  return NextResponse.json({
    ...
    invariants:["credentials_are_never_returned","authority_is_capped_by_RMF_OPERATOR_MAX_AUTHORITY","one_mutating_tool_max_per_run","owner_identity_requires_exact_allowlist_match","L2_GitHub_probe_writes_only_to_agent_run_branch","L2_GitHub_probe_never_merges","mutations_require_independent_readback_receipt"]
  });
}
