...
function config(){ if(!CONTROL_URL||!CONTROL_TOKEN)throw new Error("browser_control_not_configured"); const u=new URL(CONTROL_URL); if(u.protocol!=="https:")throw new Error("browser_control_https_required"); return{url:CONTROL_URL,token:CONTROL_TOKEN}; }
