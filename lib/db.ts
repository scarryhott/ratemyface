...
/** Paid Personal Experiments reads/writes: DB-only evidence closure. */
export const PERSONAL_EXPERIMENT_ACTION_TIMEOUT_MS = 12_000;
/** Paid Personal Intelligence reads/writes: DB-only evidence and receipts. */
export const PERSONAL_INTELLIGENCE_ACTION_TIMEOUT_MS = 12_000;
